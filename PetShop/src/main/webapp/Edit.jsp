    ...
    <body>
                ...
                <div class="modal-dialog">
                    <div class="modal-content" style="width: 450px;">
                        <form action="edit" method="post">
                            ...
                            <h4 class="modal-title" style="text-align: center;font-weight:600;">CHỈNH SỬA SẢN PHẨM</h4>
           ...
           <!--                          <label>ID</label> -->
                            ...
                            <div class="modal-footer" style="background-color:#de8ebe;">
                                <input type="submit" class="btn btn-success" style="background-color: #b0171c !important; border: 1px solid #b0171c;" value="Edit">
                            </div>
                        </form>
                    </div>
                </div>
