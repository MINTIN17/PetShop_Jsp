...
#addEmployeeModal .modal-content {
    background-color: #f0f0f0; /* Đổi màu nền của modal */
    border-radius: 10px; /* Bo tròn các góc của modal */
    box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); /* Thêm hiệu ứng bóng đổ cho modal */
}

#addEmployeeModal .modal-header {
    background-color: #de8ebe; /* Đổi màu nền của phần header của modal */
    color: white; /* Đổi màu chữ của phần header */
    border-bottom: none; /* Xóa đường viền phía dưới của header */
}

#addEmployeeModal .modal-footer {
    background-color:#de8ebe; /* Đổi màu nền của phần footer của modal */
    border-top: none; /* Xóa đường viền phía trên của footer */
}

/* Định dạng checkbox và label */
#addEmployeeModal .form-check-input {
    margin-top: 0.3rem; /* Điều chỉnh khoảng cách giữa checkbox và label */
}

#addEmployeeModal .form-check-label {
    margin-left: 0.5rem; /* Điều chỉnh khoảng cách từ checkbox đến label */
    color: #333; /* Đổi màu chữ của label */
}
...
<div class="nav11" style="position: fixed;top: 0;width: 100%;z-index: 1000;">
                <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #d261a4;">
                    <a class="navbar-brand" href="#" style="margin-left: 800px;">Admin Dashboard</a>
                </nav>
            </div>
        ...
        <div class="card-header py-3 row">
          <div class="col-sm-3">
           ...
           <div class="col-sm-9 text-right">
	           <a href="#addEmployeeModal"  class="btn btn-success" data-toggle="modal"><i class="fa-solid fa-plus"></i>Thêm tài khoản</a>
	        ...
	        <thead>
              ...
              <tbody>
                ...
                <tr>
                   ...
                   <td>${o.email}</td>
                   <td>
                     	   <a href="deleteAccount?id=${o.id}"><button type="button" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></button></a>
                   </td>
                </tr>
                </c:forEach>
              </tbody>
                ...
                <div class="modal-content">
                    <form action="addAccount" method="post">
                        <div class="modal-header">						
                            <h4 class="modal-title" style="padding-left:70px;">THÊM TÀI KHOẢN</h4>
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group form-check">
			                    ...
			                    <label class="form-check-label" for="isSell">Is Sell</label>
                			</div>
