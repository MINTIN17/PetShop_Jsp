        ...
        <div class="col-md-4 mb-4">
          ...
          <section>
            ...
            <section>
              ...
              <h4 style="padding-bottom:10px; color: #b0171c">DANH MỤC SẢN PHẨM</h4>

              <div class="text-muted small text-uppercase mb-5 danhmuc" style="padding-left:20px;">
			<c:forEach items="${listCC}" var="o">
                <p class="mb-3 fs-5"><a onclick="load(${o.cid})" class="card-link-secondary">${o.cname}</a></p>
              	<hr>
              </c:forEach>
              </div>
        ...
        <div class="col-md-8 mb-4">
          ...
          <!-- Section: Filters -->
            <section>
              ...
              <h5 class="pt-2 mb-2">Tìm kiếm</h5>
              ...
              <div class="col-md-4 mb-5">
                ...
                <div class="">
                  ...
                  <div class="text-center pt-4">
                    ...
                    <h5>${o.name }</h5>
						<p>
						    <span class="mr-1"><strong><fmt:formatNumber value="${o.price}" type="number" pattern="###,###"/>₫</strong></span>
						</p>
                  </div>
