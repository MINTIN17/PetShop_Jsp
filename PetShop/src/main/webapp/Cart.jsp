...
<html>
                                            ...
                                            <c:forEach items="${listCart}" var="o">
                                             <c:forEach items="${listProduct}" var="p">
                                                ...
                                                <tr>
                                                   ...
                                                   <td class="align-middle"><strong><fmt:formatNumber value="${p.price}" type="number" pattern="###,###.##"/>₫</strong></td>
    ...
    <ul class="list-unstyled mb-4" id="contentTotalMoney">
        <li class="d-flex justify-content-between py-3 border-bottom">
            ...
            <strong><fmt:formatNumber value="100" type="number" pattern="###,###.##"/> $</strong>
        </li>
        <li class="d-flex justify-content-between py-3 border-bottom">
        ...
        <li class="d-flex justify-content-between py-3 border-bottom">
            ...
            <strong><fmt:formatNumber value="10" type="number" pattern="###,###.##"/> $</strong>
        </li>
        <li class="d-flex justify-content-between py-3 border-bottom">
            <strong class="text-muted">Tổng thanh toán</strong>
            <h5 class="font-weight-bold"><fmt:formatNumber value="110" type="number" pattern="###,###.##"/> $</h5>
        </li>
    </ul>
    <a href="order" class="btn btn-dark rounded-pill py-2 btn-block text-white" style="background-color: #b0171c !important; border: 1px solid #b0171c;">Thanh Toán</a>
</div>
                            </div>
                        </div>
