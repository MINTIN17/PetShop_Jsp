...
<html lang="en">
    ...
    <body>
        ...
        <div id="logreg-forms" style="margin-top:120px;">
            <form class="form-signin" action="order" method="post">
               ...
               <br>
                <button class="btn btn-success btn-block" type="submit" style="background-color: #b0171c !important; border: 1px solid #b0171c;">Đặt Hàng</button>
