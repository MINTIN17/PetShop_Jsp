      ...
      <section class="mb-5">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
           ...
           <p>
    <span class="mr-1"><strong><fmt:formatNumber value="${detail.price * 0.9}" type="number" pattern="###,###.##"/>₫</strong></span>
    <span class="text-grey"><strong><s><fmt:formatNumber value="${detail.price}" type="number" pattern="###,###.##"/>₫</s></strong></span>
</p>
            ...
            <div class="mt-1">
             <button type="submit" class="btn btn-primary btn-md mr-1 mb-2" style="background-color: #b0171c !important; border: 1px solid #b0171c;">Mua ngay</button>
          ...
          <div class="col-md-6 col-lg-3 mb-5">
            ...
            <div class="">
              ...
              <div class="pt-4">
                ...
                <h5>${o.title }</h5>
              <p>
    <span class="text-danger mr-1"><strong><fmt:formatNumber value="${o.price * 0.9}" type="number" pattern="###,###.##"/>₫</strong></span>
    <span class="text-grey"><strong><s><fmt:formatNumber value="${o.price}" type="number" pattern="###,###.##"/>₫</s></strong></span>
</p>
